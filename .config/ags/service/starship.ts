...
#This config was auto generated!`
    ...
    private static async getThemeColors(): Promise<{ primary: string, secondary: string, tertiary: string }> {
        ...
        try {
            ...
            lines.forEach(line => {
                if (line.includes('$primary:')) {
                    colors.primary = line.split('#')[1]?.trim().slice(0, 6) || colors.accent;
                    ...
                    colors.tertiary = line.split('#')[1]?.trim().slice(0, 6) || colors.tertiary;
                }
            });
    ...
    public static async updateConfig() {
        ...
        try {
            ...
            console.log(`colors: ${colors.primary}, ${colors.secondary}, ${colors.tertiary}`);
        } catch (error) {
