...
ARCH_PACKAGES=(hyprland wofi fish starship hyprpicker hyprlock hypridle wl-clipboard brightnessctl bluez-utils cliphist sddm swww grim slurp playerctl polkit-gnome polkit-kde-agent xdg-desktop-portal-hyprland xdg-desktop-portal-kde cmake archlinux-xdg-menu evince)
